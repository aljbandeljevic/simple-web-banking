...
<div class=\"container\">
     ...
     <div class=\"row\">
        <div class=\"col col-sm-4\">
            <ol>
                ...
                <a href = \"withdraw.php\" class=\"list-group-item list-group-item-action active\">Withdraw Funds</a >
    ...
    if (isset($_GET["msg"]) && $_GET["msg"] == 'withdrawn') {
    ...
    if (isset($_GET["msg"]) && $_GET["msg"] == 'error') {
        echo "<div class=\"alert alert-danger\" role=\"alert\">
                Not enought money to withdraw that value!
                </div>";
    }
     echo "                  
                ...
                $(document).ready(function () {
                    $("#moneybutton").click(function(){
                        ...
                        for(let i = 0; i < data.length; i++) {
                            ...
                            usersaction += "<li><a href='withdraw-process.php?accountid=" + row.account_id + "&money=" + money + "'><img src='images/select-ico.png' width='20px' height='20px'></a></li><br />";
                        }
